...
class ProducesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produce" do
    assert_difference('Produce.count') do
      post produces_url, params: { produce: { plant_id: @produce.plant_id, quantity: @produce.quantity, units: @produce.units } }
    end
  ...
  test "should update produce" do
    patch produce_url(@produce), params: { produce: { plant_id: @produce.plant_id, quantity: @produce.quantity, units: @produce.units } }
